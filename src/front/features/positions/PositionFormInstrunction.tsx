...
export const PositionFormInstruction: FC = () => {
    ...
    <Fragment>
      <Box maxWidth={500} margin="auto" paddingTop={2} paddingBottom={2} paddingX={2}>
        <Header
          ...
          title={i18n.t("positions.form.instruction.title")}
          subtitle={i18n.t("positions.form.instruction.subtitle")}
          spacing={1}
      ...
      <Collapse in={expanded} timeout="auto" unmountOnExit>
        <ListItem disablePadding>
          <Stack spacing={2} width="100%">
            <InputControlled rows={5} name="i" label={i18n.t("positions.form.instruction.i")} />
          </Stack>
        </ListItem>
      </Collapse>
    </Fragment>
